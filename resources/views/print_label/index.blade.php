<x-app-layout title="Planeacion">
    <div class="container grid px-6 mx-auto">
        <div class="ticket">
            ...
            {{-- <button id="btnImprimir" onclick="imprimir()" class="button is-success">Imprimir</button> --}}
            <input type="button" value="Dialogo" onClick="dialogo('Eso está Caliente')" />
...
function dialogo(message){
            Android.androidAlert(message);
        }
  </script>
