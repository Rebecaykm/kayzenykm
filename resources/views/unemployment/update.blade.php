<x-app-layout title="Actualizar Paros de Línea">
    <div class="xl:container lg:container md:container sm:container grid px-6 mx-auto">
        ...
        <div class="px-4 py-3 mb-2 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <form action="{{ route('unemployment.updateImport') }}" method="post" enctype="multipart/form-data">
                @csrf
