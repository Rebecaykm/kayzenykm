<x-app-layout title="Registro de Producción">
    <div class="container grid px-6 mx-auto">
        ...
        <div class="flex flex-col justify-end flex-wrap mb-4 space-y-4 md:flex-row md:items-end md:space-x-4">
