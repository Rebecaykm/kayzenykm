<x-app-layout title="{{ __('Reporte de Registros de Producción') }}">
    <div class="container grid px-6 mx-auto">
        <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            {{ __('Reporte de Registros de Producción') }}
        </h2>
        ...
        <form action="{{ route('prodcution-record.download') }}" method="post">
            <div class="grid grid-cols-2 gap-4 px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div class="col-span-2 flex justify-end gap-4">
                    <a href="{{ route('prodcution-record.index') }}" class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-gray-600 border border-transparent rounded-lg active:bg-gray-600 hover:bg-gray-700 focus:outline-none focus:shadow-outline-gray">
