<x-app-layout title="Daily Production">
    <div class="container grid px-6 mx-auto gap-y-2">
                        ...
                        @foreach ($dailyDiurnos as $key=> $dailyDiurno)
                            <tr>
                                ...
                                <td class="px-4 py-3">
                                    @if ($dailyDiurno->SID == 'SO')
                                        <label class="block text-sm">
                                            <input id="date{{ $dailyDiurno->SORD }}"
                                                   ...
                                                   onclick="disableInputCancel(this.id)"
                                            />
                                        </label>
                                    @else
                                        <label class="block text-sm">
                                    ...
                                    @if ($dailyDiurno->SID == 'SO')
                                        <label class="flex items-center justify-center dark:text-gray-400">
                                            <input id="can{{ $dailyDiurno->SORD }}"
                                                   ...
                                                   onclick="disableInputDate(this.id)"
                                            />
                                        </label>
                                    @else
                                        <label class="flex items-center justify-center dark:text-gray-400">
                        ...
                        @foreach ($dailyNocturnos as $key => $dailyNocturno)
                            <tr>
                                ...
                                <td class="px-4 py-3">
                                    @if ($dailyNocturno->SID == 'SO')
                                        <label class="block text-sm">
                                            <input id="date{{ $dailyNocturno->SORD}}"
                                ...
                                <td class="px-4 py-3">
                                    @if ($dailyNocturno->SID == 'SO')
                                        <label class="flex items-center justify-center dark:text-gray-400">
                                            <input id="can{{ $dailyNocturno->SORD }}"
        ...
        <script>
            function disableInputCancel(id) {
                let date = document.getElementById(id.id);
                console.log(date);
            }

            function disableInputDate($id) {
