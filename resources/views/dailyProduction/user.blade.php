    ...
    <div class="container grid px-6 mx-auto gap-y-2">
        ...
        <div class="w-full overflow-x-auto text-center h-96">
            <table class="w-full whitespace-no-wrap">
                <thead>
                    <tr class="text-xs text-center font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800 sticky top-0">
        ...
        <!-- <div class="px-4 py-3 text-center rounded-md text-sm font-semibold text-gray-700 uppercase bg-gray-100 sm:grid-cols-9 dark:text-gray-500 dark:bg-gray-800">
            No data to show
        </div> -->
