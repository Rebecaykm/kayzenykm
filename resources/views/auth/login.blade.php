        ...
        <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
            <div class="flex flex-col overflow-y-auto md:flex-row">
                <div class="flex justify-center items-center h-32 md:h-auto md:w-1/2">
                    <img aria-hidden="true" class="object-cover h-36 w-72 dark:hidden" src="{{ asset('img/ykm.svg') }}" alt="Y-Tec Keylex México" />
                    ...
                    <div class="w-full">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <label class="block text-sm">
                                ...
                                <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Jane Doe" name="email" value="{{ old('email') }}" required autofocus />
                            </label>
