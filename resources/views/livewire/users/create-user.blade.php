<div>
    ...
    <button wire:click="$set('open', true)"
        class="flex items-center justify-left px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
        ...
        <x-slot name="footer">
            <div class="flex flex-row justify-end">
                <button wire:click="$set('open', false)"
                    class="flex mr-2 px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-gray-600 border border-transparent rounded-lg active:bg-gray-600 hover:bg-gray-700 focus:outline-none focus:shadow-outline-gray">
                    Cancelar
                </button>
                <button wire:click="$set('open', false)"
