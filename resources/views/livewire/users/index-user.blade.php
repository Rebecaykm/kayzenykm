<div class="container grid px-6 mx-auto">
    {{-- Titulo --}}
    <h2 class="my-2 px-2 text-2xl font-semibold text-gray-700 dark:text-gray-200">
        Usuarios
    </h2>
    <div class="flex flex- 1 flex justify-between my-2">
        {{-- Buscador --}}
        <div wire:model="search" class="flex relative w-full max-w-2xl mr-6 focus-within:text-purple-500">
            ...
            <table class="w-full whitespace-no-wrap">
                <thead>
                    <tr
                        ...
                        <th wire:click="order('name')" class="cursor-pointer px-4 py-3">Nombre</th>
                        <th wire:click="order('email')" class="cursor-pointer px-4 py-3">Correo Electrónico</th>
                        <th wire:click="order('created_at')" class="cursor-pointer px-4 py-3">Fecha Creación</th>
                        <th wire:click="order('updated_at')" class="cursor-pointer px-4 py-3">Fecha Actualización</th>
