                ...
                <label class="block text-sm">
                    ...
                    <div class="flex items-center mt-3">
                        <input type="radio" value='1'
                            ...
                            id='Type1' name="Type" />
                        <label for='Type1' class="ml-2">Final</label>
                        <input type="radio" value='2'
                            class="text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray ml-4"
                            id='Type2' name="Type" />
                        <label for='Type2' class="ml-2">Subcomponentes</label>
                    </div>
                </label>
            </div>
            <div class="flex-auto">
                <button type="submit"
                    class="w-full flex items-center justify-between px-4 py-2 mt-5 text-xs font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue">
