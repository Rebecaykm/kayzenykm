        ...
        <form method="get" action="{{ route('open-orders.index') }}">
            <div class="flex flex-row items-center justify-end my-4">
                ...
                <label class="block text-sm mx-2">
                    <input type="date" id="start" name="start" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                </label>
                <label class="flex items-center grid place-items-center text-sm mx-2">
                    <span class="text-gray-700 dark:text-gray-400">To</span>
                </label>
                <label class="block text-sm mx-2">
                    <input type="date" id="end" name="end" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                </label>
                <button type="submit" class="flex items-center justify-between px-4 py-2 mx-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
