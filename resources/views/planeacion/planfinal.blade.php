                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    ...
                                    @foreach ($plan as $plans)
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-3 text-xs text-center colmde">
                                                <div class='w-40  border  border-b-4 '>
                                            ...
                                            @while ($coni < $totalD)
                                                ...
                                                <td class="px-4 py-3 text-xs text-center colmde  ">
                                                    <div class=' border border-b-2'>
                                                        @if ($conplanq == 0)
                                                            <input type="number" maxlength="6" value="0"
                                                                class="block w-16 text-xs text-center dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input"  disbaled/>
                                                        @else
                                                            @php
                                                            ...
                                                            <input type="number" maxlength="6"
                                                                value={{ $planqn }}
                                                                class="block w-16 text-xs text-center dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input" disabled/>
                                                        @endif
                                                    </div>
                                                    <div class=' border border-t-2 mt-2 '>
                                                        @if ($confirme != 0)
