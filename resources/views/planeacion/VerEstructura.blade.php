                                            ...
                                            <td class="px-4 py-3 text-xs text-center">
                                                ...
                                                <div class="flex mt-6 text-sm">
                                                    <label class="flex items-center dark:text-gray-400">
                                                        <input name={{$namen}} id={{$namen}} onclick=" myFunction(this.id)"
                                                        type="checkbox" class="text-purple-600 form-checkbox focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" checked/>
                                                        <span class="ml-2">
                                                            No Planear
                                                        </span>
                                                    </label>
                                                  ...
                                                  <div class="flex mt-6 text-sm" >
                                                    <label class="flex items-center dark:text-gray-400">
                                                        <input name={{$namen}} id={{$namen}} type="checkbox" onclick=" myFunction(this.id)" class="text-purple-600 form-checkbox focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" />
                                                        <span class="ml-2">
                                                            No Planear
                                                        </span>
                                                    </label>
