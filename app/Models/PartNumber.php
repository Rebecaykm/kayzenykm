...
class PartNumber extends Model
{
     ...
     *
     */
    public function pressPartNumbers(): BelongsToMany
    {
        return $this->belongsToMany(PressPartNumber::class, 'part_number_press_part_number', 'part_number_id', 'press_part_number_id');
    }
}
